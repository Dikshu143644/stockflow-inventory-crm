          ...
          <AnimatePresence>
            {lastResult && (
              <motion.div
                ...
                className="w-full max-w-sm rounded-[16px] border border-orange-500/30 bg-orange-500/10 p-4 space-y-3"
              >
                <div className="flex items-center gap-2">
                  <Package className="h-5 w-5 text-orange-400" />
                  <span className="text-sm font-medium text-orange-300">Scan Successful</span>
                </div>
